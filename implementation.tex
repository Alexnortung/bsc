...
The problem is that the networks can not just get deeper and deeper since it seems that when a certain limit is reached accuracy is becoming saturated and after adding mor layers accuracy seems to degrade.
However ResNet is able to be accurate in considerably increased depth.
