...
\subsection{Exploding gradients problem}

The problem of exploding gradients refer to the fact that the gradient from the backpropagation may grow exponentially layer by layer.
